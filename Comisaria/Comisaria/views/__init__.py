from .empleado import EmpleadoView, EmpleadoUpdate, EmpleadoDetallesView, empleado_view, empleado_delete_view
...
__all__ = [
    EmpleadoView, EmpleadoUpdate, EmpleadoDetallesView, empleado_view, empleado_delete_view,
